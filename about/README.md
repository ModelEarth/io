## Background
Our javascript [state&nbsp;economic footprints](/useeio.js/footprint/states.html) use the same javascript library as the [React](../../io/charts) widgets - without the 30 second React build time. [View&nbsp;Javascript&nbsp;Reports (useeio.js)](/useeio.js/footprint/)
